...
const EditProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axiosInstance.post("/identity/edit-profile", formData);
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                const { data } = await axiosInstance.get("/identity/profile");
                ...
                <div className="w-full max-w-5xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-xl flex flex-col md:flex-row">
                        ...
                        <div className="md:w-1/3 w-full p-8 flex flex-col justify-center items-center bg-blue-600 rounded-t-2xl md:rounded-l-2xl md:rounded-tr-none">
                            ...
                            />
                            <h2 className="text-white text-3xl font-bold text-center">Update details</h2>
                            <p className="text-blue-200 mt-2 text-center">Update details with future proof.</p>
                        </div>

                        {/* Right side: Registration Form */}
                        <div className="md:w-2/3 w-full p-8 md:p-12">
                            <h1 className="text-3xl font-bold text-center text-gray-800 mb-2">Edit the data</h1>
